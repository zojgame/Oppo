       ...
       <div className={getClassName(styles, 'modalContainer')}>
            <div className={getClassName(styles, 'modal')}>
                ...
                <div className={getClassName(styles, 'content')}>
                    ...
                    <div className={getClassName(styles, 'selectorForm')}>
                        <p className={getClassName(styles, 'selectorTitle')}>ТЕХНИКА:</p>
                        <Selector text="Смартфон"/>
                    </div>
                    <div className={getClassName(styles, 'selectorSecondForm')}>
                        <div className={getClassName(styles, 'selector')}>
                            <p className={getClassName(styles, 'selectorTitle')}>БРЕНД:</p>
                            <Selector text="Apple"/>
                        </div>
                        <div className={getClassName(styles, 'selector')}>
                            <p className={getClassName(styles, 'selectorTitle')}>МОДЕЛЬ:</p>
                            <Selector text="iPhone 11"/>
                        </div>
                    </div>
